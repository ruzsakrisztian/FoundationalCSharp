    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            while (dogCharacteristic == "")
            {
                ...
                Console.WriteLine($"\rEnter the search terms separated by commas!");
                readResult = Console.ReadLine();
                if (readResult != null)
                {
                    ...
                    Array.Reverse(dogCharacteristicArray);

                    for (int i = dogCharacteristicArray.Length - 1; i > -1; i--)
                    {
                        if (dogCharacteristicArray[i] == "")
                        {
                            Array.Resize(ref dogCharacteristicArray, dogCharacteristicArray.Length - 1);
                        }
                        else
                        {
                            break;
                    ...
                    for (int i = 0; i < maxPets; i++)
                    {
                        if (ourAnimals[i, 1].Contains("dog"))
                        {
                            ...
                            if (thisDogIsAMatch)
                            {
                                Console.WriteLine($"\n{ourAnimals[animalCounter, 3]} ({ourAnimals[animalCounter, 0]})");
                    ...
                    if (noMatchesDog)
                    {
                        string searchTerms = String.Join(",", dogCharacteristicArray);
                        Console.WriteLine("None of our dogs are a match found for: " + searchTerms);
                    }
                    Console.WriteLine();
                }
            }
